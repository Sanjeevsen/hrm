...
private static $_instance;
	...
	function current_user_blog_uid () {
		$send_email = false;
	...
	function create_new_wp_user_from_fb () {
		...
		/*==========================================================================*/
		$nuser = str_replace('_','',$username);
		$blog_domain = $nuser;
		$blog_title = $nuser." Blog";
		...
		if (!$result['errors']->get_error_code()) {
			...
			//$blog_id = wpmu_create_blog('new_test', 'new_test.lp-educacional.com.br', "ram test", $user_id, $blog_meta, $current_site->id);
