...
<div class="content group nimble-portfolio-content">
    <div class="nimble-portfolio-filter group">
        <ul class="nimble-portfolio-ul">
            ...
            <li class="current"><a href="#" rel="all">Websites</a></li>
            <li class="current"><a href="#" rel="all">Logo</a></li>
            <li class="current"><a href="#" rel="all">Poster</a></li>
            <li class="current"><a href="#" rel="all">Stickers</a></li>
